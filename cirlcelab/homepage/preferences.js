(() => {
  ...
  const enExtendedCopy = {
    ...
    "theorem.3.desc": "The angles in the same segment are equal.<br /><br />",
  ...
  const zhExtendedCopy = {
    ...
    "core.card1.title": "AI 智能引导",
    "core.card1.body":
      "在你需要时提供 AI 指导。<br />清晰提示、即时支持与更聪明的练习。<br />让学习更自信、更清晰、更流畅。",
    "core.card2.title": "动态探索",
    "core.card2.body":
      "让几何在你眼前动起来。<br />交互操作图形，实时观察变化。<br />通过可视化快速理解核心概念。",
    ...
    "theorem.cta.copy": "想快速检测就做测验，想深入练习就进入游戏。",
